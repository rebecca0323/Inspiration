...
- (void)processImage:(MLKVisionImage *)image
          completion:(MLKObjectDetectionCallback)completion NS_SWIFT_NAME(process(_:completion:));
 ...
 */
- (nullable NSArray<MLKObject *> *)resultsInImage:(MLKVisionImage *)image error:(NSError **)error;
